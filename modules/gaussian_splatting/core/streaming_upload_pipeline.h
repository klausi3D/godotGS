...
public:
    ...
    struct PendingChunkUpload {
        ...
        // ALWAYS emits the 128 B PackedGaussian layout (pack_gaussians_range + sizeof(PackedGaussian)
        ...
        // the EFFECTIVE stride can flip 128->80 in between (a mixed-DC asset becomes DC-uniform ->
