...
10. **#54** — dropped tiles when overlap-record demand outruns the allocated capacity
   ...
   headroom is ≈1.8× on the world route's default 1,000,000-splat limit (≈3.6× on a
   default `GaussianSplatNode3D`, whose Balanced preset sets 500,000), and it is an
   estimate.
