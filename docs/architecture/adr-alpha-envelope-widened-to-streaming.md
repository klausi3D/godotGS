...
unchanged for the other three.)* *(Amended 2026-09-25: **#54 was accepted** as a public-alpha
limitation — bar §11 item 10, now struck — and has a `public_alpha_issue_ledger` entry, so the
list is two: #851 and #833.)* **#1030 is unlabelled** and so is invisible in the same way. The bar's hand-derived
...
| Give the gate-invisible blockers a `priority:P0`/`P1`/`release blocker` label | #851, #833, #54, #1030 — *amended 2026-09-20: #1025 was labelled `priority:P1` on 2026-09-19, and #929 closed by hand, so neither needs one; #1025 needs a `public_alpha_issue_ledger` entry instead (#1038); **amended 2026-09-22: that entry has landed, so #1025 is done — #851, #833, #54 and #1030 remain; amended 2026-09-25: #54 was accepted as a public-alpha limitation and given a ledger entry instead, so #851, #833 and #1030 remain*** | §5.5 — without this the gate never sees them |
